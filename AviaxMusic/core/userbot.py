...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("GOOGLE_MUSIC_SUPPORT")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("GOOGLE_MUSIC_SUPPORT")
                await self.one.join_chat("GOOGLE_MUSIC_UPDATE")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("GOOGLE_MUSIC_SUPPORT")
                await self.one.join_chat("GOOGLE_MUSIC_UPDATE")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("GOOGLE_MUSIC_SUPPORT")
                await self.one.join_chat("GOOGLE_MUSIC_UPDATE")
            except:
                pass
            assistants.append(5)
